...
class VariableUnitTest(unittest.TestCase):
    ...
    def test_univariate_scalar_adam_optimize(self):
        ...
        var_init = np.array([2])
        optimizer = Optimizer(objective_func, var_init)
        min_value, var_value = optimizer.adam_optimizer(learning_rate=0.001, beta1=0.9, beta2=0.999, epsilon=1e-8, num_iterations=1000)
    ...
    def test_x_y_z_squared_adam_optimize(self):
        ...
        min_value, var_value = optimizer.adam_optimizer(learning_rate=0.01, beta1=0.9, beta2=0.999, epsilon=1e-8, num_iterations=1000, tolerance=0.0000001)
        self.assertAlmostEqual(min_value, 0, places=5)
        self.assertAlmostEqual(var_value[0], 0, places=5)
        self.assertAlmostEqual(var_value[1], 0, places=5)
        self.assertAlmostEqual(var_value[2], 0, places=5)
    ...
    def test_x_y_exp_func_adam_optimize(self):
        ...
        min_value, var_value = optimizer.adam_optimizer(learning_rate=0.01, beta1=0.9, beta2=0.999, epsilon=1e-8, num_iterations=1000, tolerance=1.0e-08)
